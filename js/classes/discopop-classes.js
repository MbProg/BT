...
class Node {
   ...
   */
  constructor(id, originalId, fileId, depGoodDotString, depBadDotString, depGoodPipelineDotString, depBadPipelineDotString, type, startLine, endLine, readDataSize, writeDataSize, readLines, writeLines, heatFactor,pipelineScalarValue,doAllScalarValue,geometricDecomposition,evaluate) {
    this._id = id;
...
class CuNode extends Node {
   ...
   * @param  {number}           heatFactor      The factor of heat of this node in relation to other nodes in the graph
   */
  constructor(id, originalId, fileId, lines, depGoodDotString, depBadDotString, depGoodPipelineDotString, depBadPipelineDotString, readDataSize, writeDataSize, readLines, writeLines, heatFactor,pipelineScalarValue,doAllScalarValue,geometricDecomposition,evaluate) {
      var start = lines[0];
      var end = lines[0];
      var temp = [];
	  ...
	  super(id, originalId, fileId, depGoodDotString, depBadDotString, depGoodPipelineDotString, depBadPipelineDotString, 0, start, end, readDataSize, writeDataSize, readLines, writeLines, heatFactor,pipelineScalarValue,doAllScalarValue ,geometricDecomposition,evaluate);
...
class LoopNode extends Node {
   ...
   * @param  {number}           heatFactor            The factor of heat of this node in relation to other nodes in the graph
   */
  constructor(id, originalId, fileId, depGoodDotString,depBadDotString, depGoodPipelineDotString, depBadPipelineDotString, startLine, endLine, readDataSize, writeDataSize, readLines, writeLines, heatFactor, level, descendantNodeCount,pipelineScalarValue,doAllScalarValue,geometricDecomposition,evaluate) {
    super(id, originalId, fileId, depGoodDotString, depBadDotString, depGoodPipelineDotString, depBadPipelineDotString, 2, startLine, endLine, readDataSize, writeDataSize, readLines, writeLines, heatFactor,pipelineScalarValue,doAllScalarValue,geometricDecomposition,evaluate);
    this._level = level;
...
class LibraryFunctionNode extends Node {
   ...
   */
  constructor(id, originalId, fileId, name,depGoodDotString, depBadDotString, depGoodPipelineDotString, depBadPipelineDotString,pipelineScalarValue,doAllScalarValue,geometricDecomposition,evaluate) {
    super(id,originalId, fileId, depGoodDotString, depBadDotString, depGoodPipelineDotString, depBadPipelineDotString, 3,pipelineScalarValue,doAllScalarValue,geometricDecomposition,evaluate);
    this._name = name;
  }
...
class FunctionNode extends Node {
   ...
   * @param  {number}           heatFactor            The factor of heat of this node in relation to other nodes in the graph
   */
  constructor(id, originalId, fileId, depGoodDotString, depBadDotString, depGoodPipelineDotString, depBadPipelineDotString,  startLine, endLine, readDataSize, writeDataSize, readLines, writeLines, heatFactor, name, descendantNodeCount,pipelineScalarValue,doAllScalarValue,geometricDecomposition,evaluate) {
    super(id, originalId, fileId,  depGoodDotString, depBadDotString, depGoodPipelineDotString, depBadPipelineDotString, 1,startLine, endLine, readDataSize, writeDataSize, readLines, writeLines, heatFactor,pipelineScalarValue,doAllScalarValue,geometricDecomposition,evaluate);
    this._name = name;
    this._arguments = [];
    this._descendantNodeCount = descendantNodeCount;
  }
